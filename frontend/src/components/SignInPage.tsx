  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10 bg-background">
        ...
        >
          <Link href="/signin" className="flex items-center gap-2.5 group w-fit">
      ...
      <div className="hidden lg:flex flex-1 relative bg-gradient-to-br from-primary/5 via-emerald-50 to-primary/10 items-center justify-center border-l border-border/60">
        ...
        <div className="text-center p-10 space-y-6">
          ...
          <p className="text-muted-foreground max-w-sm mx-auto leading-relaxed">
            AI-powered predictions to minimize spoilage and connect surplus food with NGOs in need.
          </p>
        </div>
      </div>
    </div>
